...
/**
 * bean定义表示合并的bean定义，该定义在运行时支持Spring BeanFactory中的特定bean。
 ...
 * GenericBeanDefinition 的优势在于，它允许动态定义父依赖项，而不是将角色“硬编码”为根bean定义
 *
...
public class RootBeanDefinition extends AbstractBeanDefinition {
	...
	/** 用于缓存已解析的构造函数或工厂方法 Package-visible field for caching the resolved constructor or factory method. */
	@Nullable
